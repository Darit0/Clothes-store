...
class ProductControllerIT {
    ...
    void getProduct_ProductExists_ReturnsProductPage() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.get("/store/products/1")
        ...
        this.mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        status().isOk(),
                        view().name("store/products/product"),
    ...
    void getProductEditPage_ProductExists_ReturnsProductEditPage() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.get("/store/products/1/edit")
                .with(user("j.dewar").roles("MANAGER"));
    ...
    void updateProduct_RequestIsValid_RedirectsToProductPage() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.post("/store/products/1/edit")
        ...
        WireMock.stubFor(WireMock.patch("/store-api/products/1")
        ...
        this.mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        ...
                        redirectedUrl("/store/products/1")
                );

        WireMock.verify(WireMock.patchRequestedFor(WireMock.urlPathMatching("/store-api/products/1"))
                .withRequestBody(WireMock.equalToJson("""
                        {
                            "title": "Новое название",
                            "details": "Новое описание товара"
    ...
    void deleteProduct_ProductExists_RedirectsToProductsListPage() throws Exception {
        // given
        var requestBuilder = MockMvcRequestBuilders.post("/store/products/1/delete")
                .with(user("j.dewar").roles("MANAGER"))
                .with(csrf());
        ...
        WireMock.stubFor(WireMock.delete("/store-api/products/1")
                .willReturn(WireMock.noContent()));
        ...
        this.mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        status().is3xxRedirection(),
                        redirectedUrl("/store/products/list")
                );

        WireMock.verify(WireMock.deleteRequestedFor(WireMock.urlPathMatching("/store-api/products/1")));
    }
