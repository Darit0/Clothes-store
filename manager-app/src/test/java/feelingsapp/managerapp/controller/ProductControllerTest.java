...
class ProductControllerTest {
    ...
    void product_ProductDoesNotExist_ThrowsNoSuchElementException() {
        ...
        // then
        assertEquals("store.errors.product.not_found", exception.getMessage());
    ...
    void getProduct_ReturnsProductPage() {
        ...
        // then
        assertEquals("store/products/product", result);
    ...
    void getProductEditPage_ReturnsProductEditPage() {
        ...
        // then
        assertEquals("store/products/edit", result);
    ...
    void deleteProduct_RedirectsToProductsListPage() {
        ...
        // then
        assertEquals("redirect:/store/products/list", result);
    ...
    void handleNoSuchElementException_Returns404ErrorPage() {
        ...
        // when
        var result = this.controller.handlerNoSuchElementException(exception, model, response, locale);
