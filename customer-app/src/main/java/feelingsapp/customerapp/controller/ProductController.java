...
import feelingsapp.customerapp.controller.payload.NewProductReviewPayload;
import feelingsapp.customerapp.entity.Product;
import feelingsapp.customerapp.service.FavouriteProductsService;
import feelingsapp.customerapp.service.ProductReviewsService;
...
public class ProductController {
    ...
    @PostMapping("add-to-favourities")
    ...
    @PostMapping("remove-from-favourities")
