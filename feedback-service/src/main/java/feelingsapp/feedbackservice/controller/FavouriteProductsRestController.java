...
import feelingsapp.feedbackservice.controller.payload.NewFavouriteProductPayload;
import feelingsapp.feedbackservice.entity.FavouriteProduct;
import feelingsapp.feedbackservice.service.FavouriteProductsService;
...
public class FavouriteProductsRestController {
    ...
    public Mono<ResponseEntity<FavouriteProduct>> addProductToFavourites(
        ...
        return payloadMono.flatMap(payload-> this.favouriteProductsService.addProductToFavourites(payload.productId()))
